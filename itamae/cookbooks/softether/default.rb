...
execute "Download Softether source" do
  cwd "/usr/local/"
  command <<EOS
    wget -O vpnserver.tar.gz http://jp.softether-download.com/files/softether/v4.19-9599-beta-2015.10.19-tree/Linux/SoftEther_VPN_Server/64bit_-_Intel_x64_or_AMD64/softether-vpnserver-v4.19-9599-beta-2015.10.19-linux-x64-64bit.tar.gz &&
